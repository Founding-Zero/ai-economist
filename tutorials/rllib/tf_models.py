...
class FixedObsKerasConvLSTM(RecurrentTFModelV2):
    """
    The model used in the paper "The AI Economist: Optimal Economic Policy
    Design via Two-level Deep Reinforcement Learning"
    (https://arxiv.org/abs/2108.02755)
    ...
    custom_name = "fixed_obs_keras_conv_lstm"
...
ModelCatalog.register_custom_model(FixedObsKerasConvLSTM.custom_name, FixedObsKerasConvLSTM)
